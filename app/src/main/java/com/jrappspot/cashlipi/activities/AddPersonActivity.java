...
public class AddPersonActivity extends AppCompatActivity {
    ...
    private Person editingPerson = null; // এডিট মোডে non-null
    ...
    private void bindViews() {
        ...
        ivPhoto = findViewById(R.id.ivPersonPhoto);
    ...
    private void refreshSaveEnabled() {
        ...
        btnSavePerson.setEnabled(enabled);
        btnSavePerson.setAlpha(enabled ? 1f : 0.45f);
    }
    ...
    private void savePerson() {
        ...
        Person p = editingPerson != null ? editingPerson : new Person();
        ...
        if (editingPerson != null) {
            int index = db.getPersonIndexById(editingPerson.getId());
            db.updatePerson(index, p);
        } else {
            db.addPerson(p);
        }
