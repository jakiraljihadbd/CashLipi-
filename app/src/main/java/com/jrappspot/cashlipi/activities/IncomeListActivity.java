...
public class IncomeListActivity extends BaseActivity {
    ...
    @Override protected void onCreate(Bundle s) {
        ...
        TextView tvHeader = findViewById(R.id.tvListHeader);
        if(tvHeader!=null) tvHeader.setText(" আয়ের তালিকা");
        View header = findViewById(R.id.listHeader);
        if(header!=null) header.setBackground(getResources().getDrawable(R.drawable.bg_header_income));
    ...
    private void setupFilterChips(){
        ...
        LinearLayout chipRow=findViewById(R.id.chipRow);
        ...
        for(int i=0;i<labels.length;i++){
            ...
            lp.setMarginEnd(8);chip.setLayoutParams(lp);
            ...
            chip.setOnClickListener(v->{currentFilter=key;setupFilterChips();applyFilter();});
    ...
    private void applyFilter(){
        ...
        if(filteredList.isEmpty()){
            ...
            viewController.render(this, root, filteredList, "income",
                    (item,pos) -> TransactionSheetHelper.showTransactionSheet(this, db, "income", item, this::loadData),
                    (item,pos) -> TransactionSheetHelper.showTransactionSheet(this, db, "income", item, this::loadData));
