...
public class DatabaseManager {
    ...
    private List<String> getDefaultCategories(String type) {
        ...
        // ব্যবহারকারীর জন্য এটি সমানভাবে প্রযোজ্য হয়। তালিকা আরও বিস্তৃত করা হয়েছে যাতে
        // বেশিরভাগ সাধারণ আয়/ব্যয়ের খাত শুরুতেই কভার হয়ে যায়।
        List<String> list = new ArrayList<>();
        if ("income".equals(type)) {
            String[] items = {"💼 বেতন", "🏢 ব্যবসা", "📈 বিনিয়োগ", "🏠 ভাড়া আয়",
                    "🎁 উপহার", "💻 ফ্রিল্যান্সিং", "🌾 কৃষি আয়", "🐄 পশুপালন",
                    "🏦 ব্যাংক সুদ", "📤 ধার পরিশোধ পেয়েছি", "🎓 বৃত্তি/স্কলারশিপ",
                    "🧾 কমিশন", "🌍 প্রবাসী আয়", "🏆 বোনাস/ইনসেন্টিভ", "💰 অন্যান্য আয়"};
            for (String s : items) list.add(s);
        } else if ("expense".equals(type)) {
            String[] items = {"🍔 খাবার", "🚌 যাতায়াত", "🏠 বাসা ভাড়া", "🧾 বিল/ইউটিলিটি",
                    "👕 পোশাক", "📚 শিক্ষা", "💊 চিকিৎসা", "🤲 দান-সদকা", "🎉 বিনোদন",
                    "🛒 কেনাকাটা", "📱 ইন্টারনেট/মোবাইল", "⛽ জ্বালানি", "🏋️ ফিটনেস/জিম",
                    "🧴 ব্যক্তিগত যত্ন", "🏡 বাসা মেরামত", "🐾 পোষা প্রাণী", "🎂 অনুষ্ঠান/উৎসব",
                    "✈️ ভ্রমণ", "📄 ঋণ পরিশোধ", "🛡️ বীমা", "📦 অন্যান্য ব্যয়"};
            for (String s : items) list.add(s);
        }
        return list;
    }
